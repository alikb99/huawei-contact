  ...
  if (view === 'map') {
    ...
    requestAnimationFrame(function () {
      ...
      function applyFilters(){
        ...
        var centerType = (document.getElementById('centerType') && document.getElementById('centerType').value) || '';
        ...
        cards.forEach(function(card){
          ...
          var typeLabel = normalize(card.getAttribute('data-center-type-label'));
          var typeValue = normalize(card.getAttribute('data-center-type'));

          var okType = !centerType || typeValue === centerType;
          var okQuery = !q || name.indexOf(q) > -1 || addr.indexOf(q) > -1 || typeLabel.indexOf(q) > -1;

          var ok = okType && okQuery;
      ...
      var typeSel = document.getElementById('centerType');
